        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center p-4 sm:p-6">
            <div className="mx-auto mb-3 sm:mb-4 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-primary/10">
              <Icons.building className="h-6 w-6 sm:h-7 sm:w-7 text-primary" />
            </div>
              ...
              <div className="flex flex-col items-center gap-3 sm:gap-4 py-4 sm:py-6">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-2 sm:mt-3 flex justify-center">
                    <span className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold text-primary">
                      <Icons.building className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                      Administrator
                    </span>
                  </div>
                </div>
                <p className="text-xs sm:text-sm text-muted-foreground">Redirecting to admin dashboard...</p>
              </div>
            ) : (
            ...
            {!loggedInUser && (
              <>
                ...
                <div className="mt-3 sm:mt-4 text-center">
                  ...
                  >
                    Not an admin? Sign in as Employee
                  </Link>
                </div>
              </>
            )}
